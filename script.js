document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearError(field) {
      ...
      const existingError = field.parentNode.querySelector('.form-error-msg');
    ...
    function showError(field, message) {
      ...
      if (!field.parentNode.querySelector('.form-error-msg')) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd9dc2cfe-5a71-4e6b-974b-7ab8d74c045c',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd9dc2cfe-5a71-4e6b-974b-7ab8d74c045c';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd9dc2cfe-5a71-4e6b-974b-7ab8d74c045c';
